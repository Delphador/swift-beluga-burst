...
const InteractiveFeatures = () => {
  return (
    <div className="container mx-auto p-8 min-h-[calc(100vh-160px)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto"> {/* New grid container */}
        {/* Block 1: Ломай круши */}
        <Card className="w-full bg-card text-card-foreground shadow-xl p-6"> {/* Removed max-w-5xl and mx-auto */}
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-6"> {/* Changed lg:grid-cols-4 to md:grid-cols-2 for better layout within this smaller card */}
              {/* Клавиатура */}
